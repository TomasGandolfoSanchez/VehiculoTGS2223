 ...
 */
public class VehiculoGandolfoSanchezTomas2223 {
    ...
    public VehiculoGandolfoSanchezTomas2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoGandolfoSanchezTomas2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
